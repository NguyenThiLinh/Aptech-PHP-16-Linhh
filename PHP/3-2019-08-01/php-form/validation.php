...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  if(validationInput($_POST["name"]))  {
      $name = validationInput($_POST["name"]);
      if(!preg_match("/^[a-zA-z]*$/",$name)){
        ...
        if (validationInput($_POST["email"])) {
            $email = validationInput($_POST["email"]);
            ...
            if (validationInput($_POST["gender"])) {
            $gender = validationInput($_POST["gender"]);
            } else {
